...
const Navbar = () => {
  ...
  return (
    <div>
      <div className={`overlay z-40 transition-all duration-500 ease-in-out absolute top-0 left-0 h-[100vh] w-[100vw] bg-black ${menu ? "visible opacity-50" : "invisible opacity-0"}`}></div>
